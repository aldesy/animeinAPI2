...
$route['animes'] = 'anime/animeListing';
...
$route['episode'] = 'episode/load';
$route['episodes'] = 'episode/load';
$route['episodes/(:num)'] = 'episode/load/$1';

$route['API/GetAnimes'] = "API/GetAllAnimesMinim";
$route['API/GetAnime/(.+)'] = "API/GetAnimeById/$1";
